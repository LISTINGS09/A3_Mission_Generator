...
if (count _locations == 0) then {
	...
	for [{_i = 0}, {_i < 360}, {_i = _i + 5}] do {
		for [{_j = _radius * 0.25}, {_j <= (_radius * 2)}, {_j = _j + 10}] do {
			private _tempPos = _centre getPos [_j, _i];
						
			if ({_x distance2D _tempPos < 300} count _locations == 0 && !(_tempPos isFlatEmpty [8, -1, 0.25, 5] isEqualTo [])) then {
				/*private _tempMkr = createMarkerLocal [format ["TBUN_%1_%2", _zoneID, (_i * 10000) + _j], _tempPos];
				_tempMkr setMarkerTypeLocal "mil_dot";
				_tempMkr setMarkerColorLocal "ColorGrey";
				_tempMkr setMarkerAlphaLocal 0.2;*/
				
				if (count (_tempPos nearRoads 25) == 0 &&
				...
				then {
					...
					_tempMkr setMarkerTextLocal format["B%1", _i];*/
...
private _buildingList = [
	[
		...
		["S","Land_Sacks_heap_F", [3,-3.5,0], 330],
	...
	[
		...
		["S","Land_CampingTable_F", [-3.25,-2,0], 150],
		...
		["S","Land_Sacks_heap_F", [3.875,-2.375,0], 105],
		...
		["O","Land_Razorwire_F", [3.0708,6.79199,0], 195],
	...
	[
		...
		["S","Land_GarbageWashingMachine_F", [-0.512939,-5.30469,0], 315],
		["S","Land_Tyre_F", [-0.943848,-3.021,0], 195],
		["S","Land_GarbagePallet_F", [-3.25,-3.875,0], 195],
		["S","Land_Sacks_heap_F", [0.5,-2.25,0], 60],
	...
	[
		...
		["S","Land_Sacks_heap_F", [-2.375,-2.625,0], 0],
		...
		["S","Land_CampingTable_F", [1.375,-1,0], 150],
	...
	[
		...
		["S","Land_Sacks_heap_F", [-0.875,-4.125,0], 180],
	...
	[
		...
		["S","Land_Sacks_heap_F", [2.625,-6,0], 105],
	...
	[
		...
		["S","Land_Sacks_heap_F", [-5,0.625,0], 240],
		...
		["S","Land_CampingTable_F", [6.875,1.875,0], 180],
	...
	[
		...
		["S","Land_WoodenTable_small_F", [1.375,-2,0], 270],
		["S","Land_Sacks_heap_F", [4.375,0.75,0], 180],
	...
	[
		...
		["S","Land_Sacks_heap_F", [-4.4812,4.65576,0], 285],
		["S","Land_Pallet_F", [-7.875,2.875,0], 256],
	...
	[
		...
		["S","Land_WoodenTable_small_F", [-1.625,-1.5,0], 15],
	...
	[
		["S","Land_WoodenTable_small_F", [-3.75,-2.75,0], 180],
		...
		["O","Land_Razorwire_F", [-0.25,5.875,0], 180],
	...
	[
		...
		["S","Land_Sacks_heap_F", [3,-1.875,0], 255],
	...
	[
		...
		["S","Land_Sacks_heap_F", [2.625,1.5,0], 180],
	...
	[
		...
		["S","Land_Sacks_heap_F", [-0.375,-2,0], 0],
	...
	[
		...
		["S","Land_WoodenTable_small_F", [2.25,0.625,0], 0],
	...
	[
		...
		["S","Land_WoodenTable_small_F", [-1.25,-2.625,0], 165],
		["S","Land_Sacks_heap_F", [6.625,-2.125,0], 75],
	...
	[
		...
		["S","Land_WoodenTable_small_F", [1.552,0.250977,0], 270],
	...
	[
		...
		["S","Land_Sacks_heap_F", [-1.31543,3.87207,0], 330],
	...
	[
		...
		["S","Land_Sacks_heap_F", [-3.28809,-6.4375,0], 225],
	...
	[
		...
		["O","Land_BagBunker_Tower_F", [-1.65234,4.09082,0], 90],
		["S","Land_BarrelSand_F", [-2.77148,-4.8623,0], 0],
		["S","Land_Sacks_heap_F", [-1.44141,-5.19238,0], 180],
		...
		["S","Land_WoodenTable_small_F", [4.75,-0.5,0], 0],
	...
	[
		...
		["S","Land_WoodenTable_small_F", [-3.25,-0.75,0], 165],
		...
		["S","Land_Sacks_heap_F", [2.25,-6.25,0], 120],
	...
	[
		...
		["S","Land_Sacks_heap_F", [-2.10278,-2.00293,0], 150],
		...
		["S","CamoNet_BLUFOR_F", [0.0830078,3.11816,0], 180],
		["S","Land_BagFence_End_F", [2.29102,-5.92188,0], 315],
		["S","Land_WoodenTable_large_F", [1.875,-1.875,0], 265],
	...
	[
		...
		["S","Land_VitaminBottle_F", [2.73999,-0.865234,0], 270],
		["S","Land_VitaminBottle_F", [2.64038,-0.789063,0], 270],
		["S","Land_Bandage_F", [2.69995,-0.626953,0], 345],
		["S","Land_Bandage_F", [2.83081,-0.643555,0], 270],
		["S","Land_Bandage_F", [2.77979,-0.530273,0], 60],
		["S","Land_PainKillers_F", [3.5603,-1.26563,0], 270],
		["S","Land_BagFence_End_F", [3.15503,1.59473,0], 45],
		["S","Land_BagFence_End_F", [4.28003,1.34473,0], 120],
		["S","Land_Sacks_heap_F", [1.125,3.5,0], 15],
	...
	[
		...
		["O","Land_Razorwire_F", [-7.24609,2.65332,0], 90],
		...
		["O","Land_Cargo_Patrol_V2_F", [-1.87109,0.65332,0], 180],
		["S","Land_Wreck_Skodovka_F", [3.37915,-9.84668,0], 60],
		["O","Land_Razorwire_F", [-2.24609,6.40332,0], 180],
		["S","Land_WoodenTable_small_F", [2.5,3,0], 270],
		["S","Land_Sacks_heap_F", [3.125,-7.75,0], 345],

...
private _targetArr = [];
private _tempBlds = nearestObjects [_tskCentre, ["building","static"], 150, true];
...
if (count _foundBlds == 0) then { 
	_targetArr pushBack (nearestBuilding _tskCentre);
} else {
...

{
	...
	_tskActivation pushBack format["triggerActivated ZMM_%1_TR_%2", _zoneID, _forEachIndex];
